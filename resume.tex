...
\begin{itemize}
  ...
  \item {Single-view Panoptic Reconstruction with Instance-level Diffusion Priors} \hfill{\textbf{In Progress}}\\
        \textit{\small \textbf{Qingcheng Zhao}, Xiang Zhang, Zeyuan Chen, Yuan Gao, Zhuowen Tu}

  \item {\small TANGLED: Generating 3D Hair Strands from Images with Arbitrary Styles and Viewpoints} \hfill{\textbf{Under Review}}\\
