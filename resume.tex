...
\datedline{\textbf{\footnotesize Depth Guided Single-view Scene Reconstruction with Instance-level Diffusion Priors}}{Under Review}
...
\begin{itemize}
  ...
  \item Introduced depth-guided conditioning with local-global attention to encode shape priors into latent tri-plane diffusion models, enabling effective handling of occlusions and strong generalization to real images despite limited synthetic training data.
  \item Achieved state-of-the-art performance in single-view scene reconstruction through innovative depth-guided DDIM sampling and layout optimization techniques that ensure high geometric consistency between generated reconstructions and input images.
\end{itemize}
...
\begin{itemize}
  \item Led ShanghaiTech’s largest developer community, fostering innovation among 200+ members through technical workshops, competitions, and open-source initiatives. Developed \homepage[CourseBench]{https://coursebench.geekpie.club/}, a highly regarded web application that allow students to comment and discuss about courses.
