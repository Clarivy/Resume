...
\begin{itemize}
  \item {\small \cite{10.1145/3641519.3657413} Media2Face: Co-speech Facial Animation Generation With Multi-Modality Guidance} \hfill{\textbf{SIGGRAPH 2024}}\\
...
\begin{itemize}
  ...
  \item Build a web application for \href{https://hyperhuman.deemos.com/}{ChatAvatar} project based on DreamFace\cite{10.1145/3592094}, which can generate 3D avatars from a single image or text prompt.
\end{itemize}
